...
//
// フェーズ2〜3 では git_tags / github_releases / static / none と archive_extract、
// 標準 Activator を登録する。残りのストラテジ（html_scrape / single_binary /
// python_msi / rustup / android_sdk / 7z）は以降のフェーズで追加する。
